#!/bin/bash
#SBATCH -J csnet_predict_gpt2_p100           # Job name
#SBATCH -o csnet_predict_gpt2_p100.out       # Name of stdout output file
#SBATCH -e csnet_predict_gpt2_p100.err       # Name of stderr error file
...
# singularity exec --nv --home $(pwd):/home/dev csnet_gpu.sif python ../src/train.py --model gpt2 ../resources/saved_models/ ../resources/data/python/final/jsonl/train/ ../resources/data/python/final/jsonl/valid/ ../resources/data/python/final/jsonl/test
singularity exec --nv --home $(pwd):/home/dev csnet_gpu.sif python ../src/predict.py -r ligerfotis/semantic-code-search_gpt2_tf-src/2bwh1tdw
